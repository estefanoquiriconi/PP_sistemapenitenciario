                            ...
                            <div class="col-lg-5">
                                <div class="card shadow-lg border-0 rounded-lg mt-5">
                                    ...
                                    <div class="card-body">
                                            ...
                                            <% int idInternoExistente= (int )request.getSession().getAttribute("idInternoExistente");%>
                                            <h5 style="text-align: center">Interno Existente</h5>

                                            <br>
                                            <br>
                                            <div class="d-flex align-items-center justify-content-between mt-4 mb-0">
                                                 
                                                 <form action="../SvMoodificarInterno" method="GET">
                                                <input type="hidden" id="modificar" name="modificar" value="<%=idInternoExistente%>">
